        ...
        <motion.div ref={ ref } style={{ scale: scaleProgress, opacity: opacityProgress }}
            ...
            <div className="py-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full
                ...
                <ul className="flex flex-wrap mt-4 gap-2 sm:mt-auto">
                    {
                        tags.map((tag, index) => (
                            <li key={ index } className="bg-black/[0.7] px-3 py-1 text-[0.7rem] uppercase
            ...
            <Image src={ imageUrl} alt="Project I worked on." quality={ 95 }
                    className="absolute top-8 -right-40 w-[28.25rem] round-t-lg 
                               shadow-2xl transition group-even:right-[initial] 
