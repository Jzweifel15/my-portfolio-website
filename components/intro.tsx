...
export default function Intro() {
  ...
  return (
    <section ref={ ref } id="home" className="mb-28 max-w-[50rem] text-center 
      ...
      <motion.div className="flex flex-col sm:flex-row items-center justify-center 
        ...
        <a className="group bg-gray-900 text-white px-7 py-3 flex items-center 
          ...
          href="https://docs.google.com/document/d/1IS-c6YvgnADZJ6kB8mqlcSF7aTDSvjFr/edit?usp=sharing&ouid=113997322441545737596&rtpof=true&sd=true" 
          target="_blank">
        ...
        <a className="bg-white p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 
            ...
            href="https://www.linkedin.com/in/justin-zweifel-3554511aa" target="_blank">
          <BsLinkedin />
        </a>
        ...
        <a className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full 
            ...
            href="https://github.com/Jzweifel15" target="_blank">
          <FaGithubSquare />
        </a>
      </motion.div>
    </section>
