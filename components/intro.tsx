  ...
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
        ...
        <motion.div className="flex flex-col sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium"
            ...
            <a href="/Resume.docx" download className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full 
            ...
            <a href="https://www.linkedin.com/in/justin-zweifel-3554511aa" target="_blank" 
            ...
            <a href="https://github.com/Jzweifel15" target="_blank" 
